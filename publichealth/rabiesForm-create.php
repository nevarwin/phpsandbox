...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $query = "INSERT INTO rabiesinfotbl (`patientId`, `typeOfExposure`, `category`, `biteSite`, `dateBitten`, `typeOfAnimal`, `animalStatus`, `dateVaccStarted`, `animalVacc`, `woundCleaned`, `rabiesVaccine`,`animalOutcome`, `caseClass`)
            VALUES ('$patientId', '$typeOfExposure', '$category', '$biteSite', '$dateBitten', '$typeOfAnimal','$animalStatus', '$dateVaccStarted', '$animalVacc', '$woundCleaned', '$rabiesVaccine', '$animalOutcome','$caseClass')";
